...
<body>
  ...
  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_takeda.php'" value="戻る">
  </div>
  ...
  <form action="post_takeda1.php" method="post">
    ...
    <input type="hidden" name="class" value="800">
    <input type="hidden" name="name" value="takeda">
