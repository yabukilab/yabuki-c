...
<body>
  ...
  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_shimoda.php'" value="戻る">
  </div>
  ...
  <form action="post_shimoda1.php" method="post">
    ...
    <input type="hidden" name="class" value="400">
    <input type="hidden" name="name" value="shimoda">
