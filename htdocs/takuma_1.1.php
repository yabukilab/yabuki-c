...
<body>
  ...
  <h1>プロジェクトエンジニアリング</h1>

  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_takuma.php'" value="戻る">
  </div>
  ...
  <form action="post_takuma1.php" method="post">
    ...
    <input type="hidden" name="class" value="700">
    <input type="hidden" name="name" value="takuma">
