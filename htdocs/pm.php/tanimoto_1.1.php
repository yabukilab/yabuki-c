...
<body>
  ...
  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_tanimoto.php'" value="戻る">
  </div>
  ...
  <form action="post_tanimoto1.php" method="post">
    ...
    <input type="hidden" name="class" value="900">
    <input type="hidden" name="name" value="tanimoto">
