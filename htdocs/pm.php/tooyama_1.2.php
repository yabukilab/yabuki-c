...
<body>
  ...
  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_tooyama.php'" value="戻る">
  </div>
  ...
  <form action="post_tooyama2.php" method="post">
    ...
    <input type="hidden" name="class" value="1001">
    <input type="hidden" name="name" value="tooyama">
