...
<body>
  ...
  <h1>サイバーマニュファクチャリング</h1>

  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_katou.php'" value="戻る">
  </div>
  ...
  <form action="post_katou2.php" method="post">
    ...
    <input type="hidden" name="class" value="201">
    <input type="hidden" name="name" value="katou">
