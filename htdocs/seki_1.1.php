...
<body>
  ...
  <h1>プロジェクトマネジメント概論</h1>

  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_seki.php'" value="戻る">
  </div>
  ...
  <form action="post_seki1.php" method="post">
    ...
    <input type="hidden" name="class" value="600">
    <input type="hidden" name="name" value="seki">
