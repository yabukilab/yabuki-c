...
<body>
  ...
  <div class="jyugyou">
    <div class="jyugyou2">
      <button type="button" onclick="location.href='com1_shimoda.php'" class="btn">情報処理</button><br>
      <div class="comment">
        <a href="http://localhost/sample/pm.php/shimoda_1.1.php">コメントを書く</a>
      </div>
    </div>
    </div>
  </div>
