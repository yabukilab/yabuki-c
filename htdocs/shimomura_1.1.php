...
<body>
  ...
  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_shimomura.php'" value="戻る">
  </div>
  ...
  <form action="post_shimomura1.php" method="post">
    ...
    <input type="hidden" name="class" value="500">
    <input type="hidden" name="name" value="shimomura">
