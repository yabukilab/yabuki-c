...
<body>
  ...
  <h1>プログラム言語とプログラミング</h1>

  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_yabuki.php'" value="戻る">
  </div>
  ...
  <form action="post_yabuki1.php" method="post">
    ...
    <input type="hidden" name="class" value="1100">
    <input type="hidden" name="name" value="yabuki">
