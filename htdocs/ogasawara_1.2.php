...
<body>
  ...
  <div class="back">
    <input type="button" onClick="location.href='http://localhost/sample/pm.php/1_ogasawara.php'" value="戻る">
  </div>
  ...
  <form action="post_ogasawara2.php" method="post">
    ...
    <input type="hidden" name="class" value="101">
    <input type="hidden" name="name" value="ogasawara">
